 <section class="hero-wrap hero-wrap-2" style="background-image: url('assets/public/images/bg_1.jpg');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section goto-here">
        ...
        <div class="row">
        	...
        	<div class="col-md-4">
        		<div class="property-wrap ftco-animate">
        			<a href="properties-single.html" class="img" style="background-image: url(assets/public/images/work-2.jpg);">
        				<div class="rent-sale">
        	...
        	<div class="col-md-4">
        		<div class="property-wrap ftco-animate">
        			<a href="properties-single.html" class="img" style="background-image: url(assets/public/images/work-3.jpg);">
        				<div class="rent-sale">
        					<span class="rent">Rent</span>
        				</div>
        	...
        	<div class="col-md-4">
        		<div class="property-wrap ftco-animate">
        			<a href="properties-single.html" class="img" style="background-image: url(assets/public/images/work-4.jpg);">
        				<div class="rent-sale">
        					<span class="sale">Sale</span>
        				</div>
        				<p class="price"><span class="orig-price">$300,000</span></p>
        	...
        	<div class="col-md-4">
        		<div class="property-wrap ftco-animate">
        			<a href="properties-single.html" class="img" style="background-image: url(assets/public/images/work-5.jpg);">
        				<div class="rent-sale">
        					<span class="rent">Rent</span>
        				</div>
        				<p class="price"><span class="old-price">800,000</span><span class="orig-price">$3,050<small> / mo</small></span></p>
        	...
        	<div class="col-md-4">
        		<div class="property-wrap ftco-animate">
        			<a href="properties-single.html" class="img" style="background-image: url(assets/public/images/work-6.jpg);">
        				<div class="rent-sale">
        					<span class="rent">Rent</span>
        				</div>
        				<p class="price"><span class="orig-price">$300<small> / mo</small></span></p>
